...
//        List<EntityModel<Object>> allUsers = userService.getAllUsers().stream()
//                .map(user -> EntityModel.of((Object) userService.convertUserToDto(user)))
//                .toList();
//
//        List<EntityModel<Object>> allGames = gameService.getAllGames(page,size).stream()
...
//        List<EntityModel<Object>> allUsersByUsername = userService.getUsersByName(searchQuery).stream()
//                .map(user -> EntityModel.of((Object) userService.convertUserToDto(user)))
//                .toList();
//        List<EntityModel<Object>> allGamesByTitle = gameService.getGamesByTitle(searchQuery, page,size).stream()
//                .map(game -> EntityModel.of((Object) game))
//                .toList();
